...
export default function Container2() {
  return (
    <section className="sm:max-w-6xl max-w-md mx-4 sm:mx-auto mt-32" id='whatIdo'>
      <h1 className='border-b-4 inline-block border-blue-500 font-bold text-3xl text-gray-700 '>What I</h1><span className='border-b-4 inline-block border-gray-200 font-bold text-3xl text-gray-700 pl-1.5'>Do</span>
      ...
      <div className='container grid sm:grid-cols-2 grid-cols-1 gap-5 sm:gap-0 mt-10 ml-2'>
        <div className='item flex flex-col'>
          <div className='flex items-center'>
            <FaLaptopCode size={"50"} className="text-blue-500"/>
            <h1 className='text-xl sm:text-2xl font-semibold text-gray-700 ml-6'>Full Stack Development</h1>
          </div>
        ...
        <div className='item flex flex-col'>
          <div className='flex items-center'>
            ...
            <h1 className='text-xl sm:text-2xl font-semibold text-gray-700 ml-6'>Microcontroller Programming</h1>
          </div>
          <div className=' pt-0 pb-3 pl-20 pr-6'>
          <p className='text-gray-700 text-md'>My experience in full stack development allows me to work effectively in cross-functional teams, delivering high-quality products that meet business requirements and exceed user expectations</p>
          </div>
        ...
        <div className='item flex flex-col mt-2'>
          <div className='flex items-center'>
            ...
            <h1 className='text-xl sm:text-2xl font-semibold text-gray-700 ml-6'>UI/UX Design</h1>
          </div>
          <div className=' pt-0 pb-3 pl-20 pr-6'>
          <p className='text-gray-700 text-md'>My experience in full stack development allows me to work effectively in cross-functional teams, delivering high-quality products that meet business requirements and exceed user expectations</p>
          </div>
        ...
        <div className='item flex flex-col mt-2'>
          <div className='flex items-center'>
            <FaLaptopCode size={"50"} className="text-blue-500"/>
            <h1 className='text-xl sm:text-2xl font-semibold text-gray-700 ml-6'>Web design</h1>
          </div>
          <div className=' pt-0 pb-3 pl-20 pr-6'>
          <p className='text-gray-700 text-md'>My experience in full stack development allows me to work effectively in cross-functional teams, delivering high-quality products that meet business requirements and exceed user expectations</p>
          </div>
