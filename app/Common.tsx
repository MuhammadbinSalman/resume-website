...
export default function Common(props: any) {
  return (
    <div className='font-poppins'>
      {/* <div className="flex justify-center max-w-full  items-start h-[4700px] sm:h-[3500px] bg-blue-500 bg-gradient-to-br from-blue-500 to-teal-400 sm:px-24">
        ...
        <div className="bg-white w-[1350px] z-10 h-[4700px] sm:h-[3300px] shadow-lg sm:rounded-10xl p-0 sm:mt-14 mx-auto pb-0">
          {props.content}
        </div>
      </div> */}
    </div>
